...
CONTENT
    ...
    public function createHomePage(SiteInterface $site)
    {
        ...
        $homepage->setTemplateCode('index');
...
CONTENT
    ...
    public function createSite()
    {
        ...
        if ($this->container->hasParameter('exim.theme.host')) {
            $this->host = $this->container->getParameter('exim.theme.host');
        } else {
            $this->host = 'demo.davaskweblimited.com';
        }
    ...
    public function createSubSite()
    {
        ...
        $site->setHost('sub.'.$this->host);
        $site->setEnabled(true);
        $site->setName('sub.'.$this->host);
        $site->setEnabledFrom(new \DateTime('now'));
        $site->setEnabledTo(new \DateTime('+10 years'));
