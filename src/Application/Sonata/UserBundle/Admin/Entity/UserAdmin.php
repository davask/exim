        ...
        $formMapper
            ->tab('User')
                ...
                ->with('Social')
                    ...
                    ->add('youtubeUid', 'text', array('required' => false))
                    ->add('youtubeName', 'text', array('required' => false))
                    ->add('linkedinUid', 'text', array('required' => false))
                    ->add('linkedinName', 'text', array('required' => false))
                ->end()
            ->end()
            ->tab('Security')
                ->with('Status')
